...
Embedded systems developer and student, focused on microcontroller-based hardware design and digital circuit implementation.

- Working with **STM32** microcontrollers for embedded firmware and hardware-software integration
- Building with **Verilog** for digital logic and FPGA-based design
- Interested in signal processing and measurement systems at the hardware level
